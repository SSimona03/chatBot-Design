...
export function FindingRow({
  ...
  return (
    <li className="finding-row">
      <div className="grid gap-3 px-4 py-4 md:grid-cols-[6rem_minmax(12rem,1fr)_12rem_2rem] md:items-center">
        <div>
        ...
        <label>
          <span className="field-label mb-1 md:sr-only">Status</span>
          <select
            aria-label={`Change status for ${finding.title}`}
